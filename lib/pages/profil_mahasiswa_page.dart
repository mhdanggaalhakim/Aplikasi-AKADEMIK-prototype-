...
class ProfilMahasiswaPage extends StatefulWidget {
  final String userId; // authUid mahasiswa yang sedang login
  const ProfilMahasiswaPage({super.key, required this.userId});
...
class _ProfilMahasiswaPageState extends State<ProfilMahasiswaPage> {
  ...
  // ══════════════════════════════════════════════
  // EDIT PROFIL (Nama, Jurusan, Alamat)
  // NIM, Username, Email tidak bisa diubah sendiri (terikat login)
  // ══════════════════════════════════════════════
  void showEditDialog() {
    if (data == null) return;
    final cNama    = TextEditingController(text: _s(data!['nama']));
    final cJurusan = TextEditingController(text: _s(data!['jurusan']));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "Catatan: password awal kamu sama dengan NIM. Setelah diganti, "
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text("NIM: ${_s(data!['nim']).isEmpty ? '-' : _s(data!['nim'])}",
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(height: 20),
            _infoRow(Icons.badge, "NIM", _s(data!['nim'])),
            _infoRow(Icons.person_outline, "Nama", _s(data!['nama'])),
            _infoRow(Icons.school, "Jurusan", _s(data!['jurusan'])),
